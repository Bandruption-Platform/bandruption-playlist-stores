...
CREATE INDEX idx_tracks_order ON public.tracks(playlist_id, "order");
...
INSERT INTO auth.users (id, email, encrypted_password, email_confirmed_at, created_at, updated_at) VALUES
    ('11111111-1111-1111-1111-111111111111', 'demo@example.com', crypt('password123', gen_salt('bf')), NOW(), NOW(), NOW());
...
INSERT INTO public.playlists (id, user_id, title, description, is_public) VALUES
    ('22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', 'My Favorites', 'A collection of my favorite tracks', true),
    ('33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', 'Chill Vibes', 'Relaxing music for any time', false);

INSERT INTO public.tracks (playlist_id, spotify_id, title, artist, duration, "order") VALUES
    ('22222222-2222-2222-2222-222222222222', '4iV5W9uYEdYUVa79Axb7Rh', 'Never Gonna Give You Up', 'Rick Astley', 213, 1),
    ('22222222-2222-2222-2222-222222222222', '6JEK0CvvjDjjMUBFoXShNZ', 'Never Gonna Give You Up', 'Rick Astley', 213, 2),
    ('33333333-3333-3333-3333-333333333333', '0VjIjW4GlULA1WPMJyfGOk', 'Blinding Lights', 'The Weeknd', 200, 1); 